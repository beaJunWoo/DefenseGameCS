...
public class LeaderboardShowcase : MonoBehaviour
{
    ...
    [SerializeField] private Text Txt_UserNickName;
    ...
    {
        _playerScoreText.text = socre.ToString();
        _playerScore = socre;
    }

    public void Submit()
    {
        Leaderboards.DemoSceneLeaderboard.UploadNewEntry(Txt_UserNickName.text, _playerScore, Callback, ErrorCallback);
    }
